#!/bin/bash
#SBATCH --job-name=hr_c_abb       # create a short name for your job
...
#SBATCH --output=slurm_logs/cma_hair_control_abb%j.out
#SBATCH --error=slurm_logs/cma_hair_control_abb%j.err
...
python codebase/tasks/identity_rules/cma.py  --use_behavioral_tom --context_type control --base_rule ABB --template_names hair_styling --prompt_num 50 --max_new_tokens 5 --activation_name z --model_type Qwen2.5-14B-Instruct --question_style instruction --better_cma