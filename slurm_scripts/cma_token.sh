...
python codebase/tasks/identity_rules/cma.py --use_behavioral_tom --context_type  abstract --base_rule ABA --template_names food_truck --prompt_num 500 --max_new_tokens 10 --samples_per_condition 1 --activation_name z
