#!/bin/bash
#SBATCH --job-name=fd_c_aba        # create a short name for your job
...
#SBATCH --output=slurm_logs/cma_food_cont_aba%j.out
#SBATCH --error=slurm_logs/cma_food_cont_aba%j.err
