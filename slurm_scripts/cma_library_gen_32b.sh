#!/bin/bash
#SBATCH --job-name=cma_g_lib_big        # create a short name for your job
...
#SBATCH --output=slurm_logs/cma_lib_big%j.out
#SBATCH --error=slurm_logs/cma_lib_big_%j.err
...
python codebase/tasks/identity_rules/cma.py  --use_behavioral_tom --context_type abstract --base_rule ABA --template_names library_book --prompt_num 30 --max_new_tokens 20 --activation_name z --model_type Qwen2.5-32B-Instruct --question_style instruction